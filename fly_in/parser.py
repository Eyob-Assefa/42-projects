...
class Parser:
    ...
    def load_file(self) -> None:
        ...
        try:
            ...
            raise ParseError(f"Error: The file '{self.filepath}' was not found.")
        except Exception as e:
            # Catching other read errors and passing them nicely
    ...
    def _parse_zone(
        ...
        self.graph.adj_list[zone] = [] # Initialize empty adjacency list
